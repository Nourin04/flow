      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-slate-100 bg-white h-screen sticky top-0 px-4 py-6 justify-between select-none">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-3 px-3">
            <div className="w-9 h-9 rounded-xl gradient-accent flex items-center justify-center text-white shadow-md shadow-violet-200">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>
              </svg>
            </div>
            <div>
              <span className="font-display font-semibold text-lg tracking-tight text-slate-800">Flow</span>
              <p className="text-[10px] text-slate-400 -mt-1 font-medium">Your money, clearly.</p>
            </div>
          </div>
